...
#define CFG_LORA_PIN_RXEN     17           // (sx127x - unused, sx126x - RXEN pin number)
...
#define CFG_WIFI_ENABLE       true
#define CFG_WIFI_SSID         "123"    // connect to SSID or run as this SSID in AP mode
#define CFG_WIFI_KEY          "12345678"     // wifi key
...
#define CFG_APRS_RAW_BKN      "BX4ACP-3>OBM2BM,WIDE1-1:=2403.87NL12035.35E#[LoRa APRS Digi 430.640MHz]"
...
#define CFG_DIGIREPEAT        true   // digirepeat incoming packets
