...
//#define CFG_WIFI_SSID         "dynasty"    // connect to SSID or run as this SSID in AP mode
//#define CFG_WIFI_KEY          "27896099"     // wifi key
//#define CFG_WIFI_SSID         "CHT5506"    // connect to SSID or run as this SSID in AP mode
//#define CFG_WIFI_KEY          "tcdmr4379"     // wifi key
#define CFG_WIFI_SSID         "R04-F5D8"    // connect to SSID or run as this SSID in AP mode
#define CFG_WIFI_KEY          "wxmjw37838"     // wifi key
// Bluetooth
...
#define CFG_APRS_LOGIN        "BM3DQG"
#define CFG_APRS_PASS         "21420"
#define CFG_APRS_FILTER	      "r/24.11/120.42/50"  // multiple are space separated, see http://www.aprs-is.net/javAPRSFilter.aspx
//#define CFG_APRS_RAW_BKN      "BX2AIO>APZMDM,WIDE1-1:=2459.44NL12127.70E&LoRA 430.64MHz/BW125/SF12/CR8/0x12"//測試參數
#define CFG_APRS_RAW_BKN      "BM3DQG>APZMDM,WIDE1-1:=2500.38NL12120.44E&LoRA 430.64MHz/BW125/SF12/CR8/0x12"//測試參數
